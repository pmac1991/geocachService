...
<html>
	...
	<body>
		...
		<div id="page-body" role="main">
			<h1>Welcome to GeoCach service!</h1>
			<p>In here you can post your geocaches and allow other users to solve them!
			   Besides that you can eaisly mark geocaches visited by you!			
			   </p>
